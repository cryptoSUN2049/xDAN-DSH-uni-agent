...
# Settings v2 (user decision, 16:05 UTC): student prefix caching on, 8192-token steps,
# gpu_memory_utilization 0.45, identical to pipe-r4.
...
HARBOR_REWARD_MODE=pass_ratio DAPO=0 ROLLOUT_MAX_NUM_BATCHED_TOKENS=8192 ROLLOUT_ENABLE_PREFIX_CACHING=True \
