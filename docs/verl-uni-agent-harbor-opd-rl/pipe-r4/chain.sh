...
MODEL_PATH=$M/Qwen3.5-9B GPU_MEMORY_UTILIZATION=0.40 TEACHER=1 TEACHER_MODEL_PATH=$M/Qwen3.8-27B TEACHER_GPU_MEM=0.85 \
HARBOR_REWARD_MODE=pass_ratio DAPO=0 ROLLOUT_MAX_NUM_BATCHED_TOKENS=4096 ROLLOUT_ENABLE_PREFIX_CACHING=False TEACHER_MAX_NUM_BATCHED_TOKENS=8192 \
